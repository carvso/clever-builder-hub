        ...
        <div className="flex flex-col gap-4 mb-8 animate-slide-in-left">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button 
              ...
              className="px-4 py-2 rounded-full border border-gray-200 hover:border-primary hover:bg-primary/5 text-sm font-medium transition-colors flex items-center gap-2 hover-lift"
            >
