...
export default function CatalogoCtaSection() {
  ...
  return (
    <section ref={sectionRef} className="overflow-hidden">
      <div className="h-full rounded-3xl bg-gradient-to-br from-secondary to-secondary/80 overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-8 py-12 px-8 md:px-12 relative">
          <div className={`text-white space-y-6 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
            ...
            <div className="pt-4">
              <Link 
                to="/catalogo" 
                className={`inline-flex items-center gap-2 px-6 py-3 bg-white text-secondary rounded-xl hover:bg-white/90 transition-colors font-medium hover-lift ${
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-6 right-0 translate-x-1/3 bg-white py-3 px-5 rounded-xl shadow-lg">
                <div className="text-center">
                  <p className="text-sm text-gray-500">Disponibili da</p>
                  <p className="text-xl font-bold text-secondary">€0.50/pz</p>
                </div>
              </div>
            </div>
          </div>
